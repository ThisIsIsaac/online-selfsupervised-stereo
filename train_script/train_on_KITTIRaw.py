...
def main():
    ...
    train_left, train_right, train_disp, train_entp = kitti_raw_load_paths_from_file("unlabeled_util/exp_train_set.txt", "final768_res3.3_maxdisp768")
    ...
    loader_kitti15 = DA.myImageFloder(train_left, train_right, train_disp, rand_scale=[0.9, 2.4 * scale_factor],
                                      ...
                                      left_entropy=train_entp, no_aug=True)
    ...
    print('%d batches per epoch' % (len(loader_kitti15) // args.batch_size))
