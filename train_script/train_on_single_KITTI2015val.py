...
def main():
    ...
    mode = "image"
    image_name = "0000000040.npy"
    train_left, train_right, train_disp, train_entp = kitti_raw_loader(root_dir, disp_dir, entp_dir,
                                                                       mode=mode, image_name=image_name)
    train_left = train_left * args.batch_size * 200
    train_right = train_right * args.batch_size * 200
    train_disp = train_disp * args.batch_size * 200
    train_entp = train_entp * args.batch_size * 200
