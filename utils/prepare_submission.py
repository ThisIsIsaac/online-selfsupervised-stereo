...
def prepare_kitti(in_path, out_path):
    ...
    dir_name = os.path.basename(os.path.normpath(in_path))
    
    folder_name = time.strftime(dir_name +"_%x_%X")
...
if __name__ == "__main__":
    in_path = "/home/isaac/high-res-stereo/output/eval_final_color_model"
